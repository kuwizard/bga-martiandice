 ...
 * states.inc.php
 *
 * MartianDiceKW game states description
 *
 */
...
$machinestates = array(
    ...
    3 => array(
        "name" => "diceChoosing",
        "description" => clienttranslate('${actplayer} must choose a dice type to set aside'),
        "descriptionmyturn" => clienttranslate('${you} must choose a dice type to set aside'),
        "type" => "activeplayer",
        "args" => "argPlayerTurn",
